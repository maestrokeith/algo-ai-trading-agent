"""Shared printing/logging helpers for the live loop package split."""
...
def log_inverse_state_line(
    ...
    *,
    ...
    """e.g. ``SQQQ state — shares=42 scale_count=3/3 avg_entry=31.20 last_entry=32.10 unrealized_pnl=-50.00``."""
    sym_u = str(symbol).upper()
