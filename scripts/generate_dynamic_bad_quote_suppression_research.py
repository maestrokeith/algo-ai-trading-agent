#!/usr/bin/env python3
"""Generate read-only dynamic bad-quote suppression research."""
...
from src.dynamic_bad_quote_suppression_research import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(render_dynamic_bad_quote_suppression_research(report))
