#!/usr/bin/env python3
"""Generate read-only dynamic entry-alignment explainability report."""
...
from src.dynamic_entry_alignment_report import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(render_dynamic_entry_alignment_report(report))
