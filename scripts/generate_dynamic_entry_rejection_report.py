#!/usr/bin/env python3
"""Generate dynamic entry rejection explainability report."""
...
from src.dynamic_entry_rejection_report import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(render_dynamic_entry_rejection_report(report))
