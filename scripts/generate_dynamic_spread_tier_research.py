#!/usr/bin/env python3
"""Generate read-only dynamic spread-tier research."""
...
from src.dynamic_spread_tier_research import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(render_dynamic_spread_tier_research_report(report))
