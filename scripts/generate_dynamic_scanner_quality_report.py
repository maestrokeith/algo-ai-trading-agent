#!/usr/bin/env python3
"""Generate read-only dynamic scanner quality report."""
...
from src.dynamic_scanner_quality_report import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(render_dynamic_scanner_quality_report(report))
